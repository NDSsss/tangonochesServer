...
class TicketsSeeder extends Seeder
{
    ...
    public function run()
    {
        $values = [];
        $values[] = [
            'ticket_start_date' => '2000.11.06',
            'ticket_end_date' => '2000.12.06',
            'ticket_count_type_id' => 1,
...
//        }
    ...
    function getTemplateTicket($dateNumber, $ticket_count_type_id, $ticket_event_type_id, $student_id, $teacher_id, $is_in_pair = false)
    {
        switch ($dateNumber) {
            ...
            case 2:
                return [
                    'ticket_start_date' => '2019.12.07',
                    'ticket_end_date' => '2020.01.07',
                    'ticket_count_type_id' => $ticket_count_type_id,
                    'ticket_event_type_id' => $ticket_event_type_id,
                    'student_id' => $student_id,
                    'teacher_id' => $teacher_id,
            ...
            case 3:
                return [
                    'ticket_start_date' => '2020.01.08',
                    'ticket_end_date' => '2020.02.08',
                    'ticket_count_type_id' => $ticket_count_type_id,
                    'ticket_event_type_id' => $ticket_event_type_id,
                    'student_id' => $student_id,
                    'teacher_id' => $teacher_id,
